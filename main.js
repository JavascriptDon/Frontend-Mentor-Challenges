...
todoCount.innerText = document.querySelectorAll('.list').length;


/* Change Theme */
const themeIcon = document.querySelector('.todo-theme');
...
/*Add items */
const addButton = document.querySelector('.todo-item button');
const itemInput = document.getElementById('todo-item');
